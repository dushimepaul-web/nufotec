...
return [
    ...
    "token" => "j8D4W16avimu9kWT741NO8rdjA3yfpWK",
    ...
    // Bot`s URL - Link to your server. At ( {server link}/hook ), when POST is requested, processing occurs in index.php
    "botUrl" => "https://nufotec.com/hook"
];
