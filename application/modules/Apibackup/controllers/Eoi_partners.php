...
class Entente extends MY_Controller {
    ...
    public function confirme()
    {
        ...
        $this->load->view('Confirmee_View', $data);
    }   
    ...
    public function joinMeet($room_id = null)
    {
        ...
        // Vérifier que l'utilisateur est autorisé (médecin ou patient de cette consultation)
        $user_id = $this->session->userdata('user_id');
        $user_type = $this->session->userdata('type_utilisateur');
        
        $is_authorized = false;
        
        if ($user_type === 'medecin' && $consultation['medecin_id'] == $user_id) {
            $is_authorized = true;
        ...
        // Mettre à jour le statut si première connexion (médecin)
        ...
        // Rediriger vers votre contrôleur Videocall avec le room_id
