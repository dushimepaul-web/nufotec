...
<body>
                ...
                <div class="form-section" id="step-4">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="engagement_model" class="form-select" id="engagement_model">
                            <option value="">Sélectionner...</option>
                            <option value="Success-Based">Success-Based (Succès uniquement)</option>
                            <option value="Retainer + Success">Retainer + Success (Forfait + Succès)</option>
                            <option value="Referral">Referral (Parrainage)</option>
    ...
    <script>
        ...
        function initCharCounters() {
            const fields = ['full_name', 'firm_name', 'mobile', 'whatsapp', 'website', 
                           'registration_number', 'regulatory_authority'];
