    ...
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="socialTable" class="table table-striped table-hover align-middle mb-0" style="width:100%">
                    <thead class="table-light">
                        <tr>
                            <th class="text-center" style="width: 5%">#</th>
                            <th class="text-center" style="width: 8%">Ordre</th>
                            <th style="width: 15%">Plateforme</th>
                            <th style="width: 15%">Label</th>
                            <th style="width: 30%">URL</th>
                            <th class="text-center" style="width: 10%">Icône</th>
                    ...
                    <?php if (!empty($social_links)): ?>
                        <?php $i = 1; foreach ($social_links as $value): ?>
                        <tr>
                            <td class="text-center"><?= $i++ ?></td>
                            <td class="text-center">
                                <span class="badge bg-light text-dark border"><?= $value['display_order'] ?></span>
                            </td>
                            <td>
                                <strong class="text-uppercase text-primary"><?= htmlspecialchars($value['platform']) ?></strong>
                            </td>
                            <td><?= htmlspecialchars($value['label']) ?></td>
                            <td>
                                <a href="<?= htmlspecialchars($value['url']) ?>" target="_blank" class="text-decoration-none text-truncate d-inline-block" style="max-width: 250px;" title="<?= htmlspecialchars($value['url']) ?>">
                                    <?= htmlspecialchars($value['url']) ?>
                                </a>
                            </td>
                            <td class="text-center">
                                <i class="bi bi-<?= $value['icon_name'] ?>" style="font-size: 1.5rem; color: #0f4c3a;"></i>
                                <br><small class="text-muted" style="font-size: 0.7rem;"><?= $value['icon_name'] ?></small>
                            </td>
                            <td class="text-center">
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="8" class="text-center py-5">
                                ...
                                <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#create_social" class="btn btn-primary btn-sm mt-2">
                                    <i class="bx bx-plus"></i> Ajouter un lien
                                </a>
                            </td>
                        </tr>
                    <?php endif; ?>
            ...
            <form action="<?= base_url('social-create') ?>" method="POST">
                <div class="modal-body p-4">
                    ...
                    <div class="row g-3 mt-2">
                        ...
                        <div class="col-md-6">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="target_blank" id="create_target_blank" value="1" checked>
