                        ...
                        <?php if (!empty($social_links)): $i = 1; foreach ($social_links as $value): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <i class="bx bx-<?= $value['icon_name'] ?>" style="font-size: 1.5rem; color: #0f4c3a;"></i>
                                    ...
                                    <div class="modal-content border-0 shadow">
                                        ...
                                        <div class="modal-body p-4">
                                            <div class="text-center mb-3">
                                                <i class="bx bx-<?= $value['icon_name'] ?>" style="font-size: 3rem; color: #0f4c3a;"></i>
                                    ...
                                    <div class="modal-content border-0 shadow">
                                        ...
                                        <form action="<?= base_url('social-delete') ?>" method="POST">
                                            ...
                                            <div class="modal-body p-4 text-center">
                                                ...
                                                <h5 class="mt-3">Êtes-vous sûr de vouloir supprimer ce lien ?</h5>
                                                <p class="text-muted"><?= htmlspecialchars($value['label']) ?></p>
                                            </div>
                                            <div class="modal-footer bg-light">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="icon_name" value="link" required>
...
$(document).ready(function() {
    $('#socialTable').DataTable({
        ...
        order: [[1, 'asc']], // Tri par la colonne "Ordre" (index 1)
        pageLength: 10,
        responsive: true
    });
