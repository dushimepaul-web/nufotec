            ...
            <div class="table-responsive">
                ...
                <table id="consultationsTable" class="table table-hover align-middle" style="width:100%">
                    ...
                    <?php if (!empty($consultations)): $i = 1; foreach ($consultations as $value): 
                        ...
                        // Patient info (patient_fullname gère aussi les patients non connectés)
                        ...
                        <div class="card border-0 shadow-sm h-100">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="https://wa.me/<?= preg_replace('/[^0-9]/', '', $value['whatsapp_number']) ?>" target="_blank" class="text-info small">

                                        <i class="bx bx-logo-whatsapp me-2"></i>

                                        <span>WhatsApp: <?= htmlspecialchars($value['whatsapp_number'] ?? 'Non renseigné') ?></span>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="text" class="form-control" name="whatsapp_number" value="<?= $value['whatsapp_number'] ?? '' ?>" placeholder="+257 79 123 456">
                                                        </div>
