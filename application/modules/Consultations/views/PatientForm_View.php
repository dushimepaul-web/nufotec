...
<a href="#main-content" class="skip-link"><i class="bi bi-skip-forward"></i> Aller au contenu principal</a>

<!-- SECTION HERO -->
<section class="consultation-hero">
    <div class="container">
        <h1 id="hero-title"><i class="bi bi-heart-pulse"></i> Consultation en ligne</h1>
        <p id="hero-subtitle"><i class="bi bi-shield-check"></i> Sécurisé et confidentiel</p>
    </div>
</section>
                ...
                <form id="consultationForm" 
                    ...
                    <div class="step-content" id="step1">
                        <div class="form-header">
                            ...
                            <div class="header-text">
                                <h2><i class="bi bi-person"></i> Vos informations personnelles</h2>
                        ...
                        <div class="form-grid">
                            <div class="form-group full-width">
                                ...
                                <div class="invalid-feedback"><i class="bi bi-exclamation-circle"></i> Veuillez entrer votre nom complet (minimum 3 caractères)</div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="autocomplete-container" style="position: relative;">
                                    ...
                                    <div class="invalid-feedback"><i class="bi bi-exclamation-circle"></i> Veuillez sélectionner votre pays</div>
                                </div>
                            </div>
                    ...
                    <div class="step-content hidden" id="step2">
                        <div class="form-header">
                            ...
                            <div class="header-text">
                                <h2><i class="bi bi-activity"></i> Vos symptômes</h2>
                                <p><i class="bi bi-pencil-square"></i> Décrivez précisément vos symptômes</p>
                            </div>
                        </div>

                        <div class="form-group full-width" style="margin-bottom: 20px;">
                            <label class="form-label" for="symptoms">
                                <i class="bi bi-chat-text"></i> Description détaillée <span class="required">*</span>
                            </label>
                        ...
                        <div class="form-group full-width" style="margin-bottom: 20px;">
                            <label class="form-label" for="symptoms_duration">
                                <i class="bi bi-clock-history"></i> Depuis combien de temps ?
                            </label>
                            <div style="position: relative;">
                        ...
                        <div class="form-group full-width" style="margin-bottom: 20px;">
                            <label class="form-label">
                                <i class="bi bi-question-circle"></i> Avez-vous déjà consulté un médecin pour ces symptômes ?
                            </label>
                    ...
                    <div class="step-content hidden" id="step3">
                        <div class="form-header">
                            ...
                            <div class="header-text">
                                <h2><i class="bi bi-folder"></i> Documents médicaux (optionnel)</h2>
                                <p><i class="bi bi-shield-lock"></i> Sécurisé et confidentiel</p>
                            </div>
                        </div>
                        ...
                        <div class="upload-section">
                            <div class="upload-header">
                                ...
                                <div>
                                    ...
                                    <p><i class="bi bi-info-circle"></i> Téléchargez vos analyses, radios, résultats d'examens (PDF, JPG, PNG)</p>
                                </div>
                            </div>
                            ...
                            <div class="upload-box" tabindex="0">
                                ...
                                <small style="color: var(--text-muted); font-size: 0.6875rem;"><i class="bi bi-file-earmark"></i> PDF, JPG, PNG (max 5 Mo)</small>
                        ...
                        <div class="upload-section">
                            <div class="upload-header">
                                ...
                                <div>
                                    ...
                                    <p><i class="bi bi-info-circle"></i> Téléchargez vos ordonnances antérieures (PDF, JPG, PNG)</p>
                                </div>
                            </div>
                    ...
                    <div class="step-content hidden" id="step4">
                        <div class="form-header">
                            ...
                            <div class="header-text">
                                <h2><i class="bi bi-eye"></i> Récapitulatif de votre consultation</h2>
                                <p><i class="bi bi-info-circle"></i> Vérifiez vos informations avant validation</p>
                            </div>
                        </div>

                        <div class="consultation-summary">
                            <div class="summary-title"><i class="bi bi-person"></i> Vos informations</div>
                            ...
                            <div class="summary-title" style="margin-top: 20px;"><i class="bi bi-activity"></i> Vos symptômes</div>
                            <div class="summary-item" style="margin-bottom: 15px;">
                                <div class="value" id="summary-symptoms" style="white-space: pre-wrap;">-</div>
                            </div>

                            <div class="summary-total">
                                <span><i class="bi bi-cash-stack"></i> Montant total à payer</span>
                                <?php
                        ...
                        <div class="terms-checkbox">
                            ...
                            <label for="terms">
                                <i class="bi bi-file-text"></i> J'accepte les <a href="<?= base_url('conditions'); ?>" target="_blank">conditions générales</a> et la politique de confidentialité
                            </label>
                        </div>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn-submit" id="submitBtn">
                                <i class="bi bi-check-lg"></i> Confirmer et payer
                            </button>
                        </div>
                    </div>
                </form>
        ...
        <div class="col-lg-4">
            <div class="info-panel">
                <div id="doctor-card-container">
                    <div class="doctor-info-card">
                        ...
                        <h4 class="doctor-name">
                            <i class="bi bi-person-badge"></i><?= htmlspecialchars($medecin['prenom'] ?? '') . ' ' . htmlspecialchars($medecin['nom'] ?? 'Médecin') ?>
                        </h4>
                        ...
                        <div class="burundi-price" style="margin-top: 10px; padding: 10px 12px; background: rgba(255,255,255,0.2); border-radius: 8px; border-left: 4px solid var(--accent); font-size: 0.9rem;">
                            <i class="bi bi-geo-alt-fill" style="color: var(--accent); margin-right: 6px;"></i>
                ...
                <ul>
                    ...
                    <li><span>5</span> <i class="bi bi-person-check"></i> Recevez la réponse du médecin</li>
                </ul>
                ...
                <div style="margin-bottom: 15px;">
                    <strong style="font-weight: bold; display: block; margin-bottom: 5px;">
                        <i class="bi bi-wallet2" style="margin-right: 5px;"></i> Moyens de paiement acceptés :
                    </strong>
...
<div class="success-modal" id="successModal" role="dialog" aria-modal="true" aria-labelledby="modalTitle">
    <div class="success-content">
        ...
        <p><i class="bi bi-envelope-check"></i> Votre demande a été enregistrée avec succès</p>
        
        <div class="tracking-box">
            <label><i class="bi bi-upc-scan"></i> Votre numéro de suivi</label>
