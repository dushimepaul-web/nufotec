...
<style>
    ...
    .modal-succes .modal-header {
        background: linear-gradient(135deg, var(--primaire), var(--primaire-clair));
        color: white;
        border: none;
        padding: 2rem;
    }
...
<div class="contenant-principal">
    <div class="carte-formulaire">
        ...
        <div class="etapes-progression">
            ...
            <div class="etape" data-etape="3" onclick="allerEtape(3)">
                ...
                <div class="texte-etape">Types d'intérêt</div>
            </div>
            <div class="etape" data-etape="4" onclick="allerEtape(4)">
                <div class="numero-etape">4</div>
                <div class="texte-etape">Engagement</div>
            </div>
        ...
        <form id="formulaireInvestisseur" novalidate>
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <label class="label-formulaire">
                            ...
                            <i class="fas fa-info-circle icone-infobulle" data-bs-toggle="tooltip" title="Votre nom et prénom"></i>
                        </label>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="retour-invalide" id="organisation-erreur"></div>
                        <div class="compteur-caracteres" id="organisation-compteur">0/150</div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="groupe-saisie">
                            <span class="groupe-saisie-texte"><i class="fas fa-user-tie"></i></span>
                            <input type="text"
                                   class="controle-formulaire"
                                   name="titre_poste"
                                   id="titre_poste"
                                   placeholder="Directeur des Investissements"
                                   maxlength="150">
                        </div>
                        <div class="retour-invalide" id="titre_poste-erreur"></div>
                        <div class="compteur-caracteres" id="titre_poste-compteur">0/150</div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="retour-invalide" id="telephone-erreur"></div>
                        <div class="compteur-caracteres" id="telephone-compteur">0/50</div>
                    </div>
                </div>
            ...
            <div class="section-formulaire" id="etape-2">
                ...
                <p class="sous-titre-section">Indiquez votre pays d'origine</p>
            ...
            <div class="section-formulaire" id="etape-3">
                <h2 class="titre-section">
                    <i class="fas fa-hand-holding-usd" style="color: var(--avertissement);"></i>
                    Types d'intérêt
                </h2>
                <p class="sous-titre-section">Sélectionnez vos domaines d'intérêt pour le partenariat</p>

                <div class="boite-info">
                    <i class="fas fa-info-circle"></i>
                    <div>
                        <strong>Important :</strong> Cette sélection nous aide à comprendre vos objectifs d'investissement.
                    </div>
                </div>
                ...
                <div class="mb-4">
                    <label class="label-formulaire d-block mb-3">
                        ...
                        Types d'intérêt <span class="text-danger">*</span>
                    </label>
                    <div class="grille-coches" id="groupeInteret">
                        <?php
                        $interets = [
                            'interet_capitaux_propres' => ['label' => 'Capitaux Propres', 'icone' => 'fa-chart-pie', 'couleur' => '#0B4F2E', 'desc' => 'Investissement en actions'],
                            'interet_dette' => ['label' => 'Dette', 'icone' => 'fa-hand-holding-usd', 'couleur' => '#FF6B35', 'desc' => 'Financement par emprunt'],
                            'interet_financement_mixte' => ['label' => 'Financement Mixte', 'icone' => 'fa-blender', 'couleur' => '#3498DB', 'desc' => 'Combinaison capitaux propres et dette'],
                            'interet_subvention' => ['label' => 'Subvention', 'icone' => 'fa-gift', 'couleur' => '#9B59B6', 'desc' => 'Financement non remboursable'],
                            'interet_partenariat_strategique' => ['label' => 'Partenariat Stratégique', 'icone' => 'fa-handshake', 'couleur' => '#27ae60', 'desc' => 'Collaboration stratégique'],
                            'interet_collaboration_technique' => ['label' => 'Collaboration Technique', 'icone' => 'fa-flask', 'couleur' => '#00BCD4', 'desc' => 'Assistance technique et R&D'],
                            'interet_achat_distribution' => ['label' => 'Achat / Distribution', 'icone' => 'fa-truck', 'couleur' => '#e67e22', 'desc' => 'Accords d\'achat et distribution']
                        ];
                        foreach ($interets as $cle => $int):
                        ?>
                        <div class="carte-coche" onclick="basculerCoche(this, 'interet')">
                            <input type="checkbox" name="<?= $cle ?>" value="1">
                            <div class="icone-coche" style="background: <?= $int['couleur'] ?>20; color: <?= $int['couleur'] ?>;">
                                <i class="fas <?= $int['icone'] ?>"></i>
                            </div>
                    ...
                    <div class="retour-invalide erreur-interet" style="display: none;">Veuillez sélectionner au moins un type d'intérêt</div>
                </div>

                <div class="mb-4">
                    <label class="label-formulaire">Autre intérêt (précisez)</label>
                    <input type="text"
                           class="controle-formulaire"
                           name="interet_autre"
                           id="interet_autre"
                           placeholder="Décrivez tout autre intérêt"
                           maxlength="255">
                    <div class="compteur-caracteres" id="interet_autre-compteur">0/255</div>
                </div>
            ...
            <div class="section-formulaire" id="etape-4">
                ...
                <p class="sous-titre-section">Informations sur votre capacité d'investissement</p>
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <select name="fourchette_engagement" class="selection-formulaire" id="fourchette_engagement">
                            <option value="">Sélectionnez une option</option>
                            <option value="Below 250K">Moins de 250K €</option>
                            <option value="250K-1M">250K € - 1M €</option>
                            <option value="1M-5M">1M € - 5M €</option>
                            <option value="5M+">5M € et plus</option>
                            <option value="To be discussed">À discuter</option>
                        </select>
                        <div class="retour-invalide" id="fourchette_engagement-erreur"></div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="calendrier" class="selection-formulaire" id="calendrier">
                            <option value="">Sélectionnez une option</option>
                        ...
                        <div class="retour-invalide" id="calendrier-erreur"></div>
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="grille-coches">
                        <?php
                        $domaines = [
                            'focus_laboratoire_recherche' => ['label' => 'Laboratoire de Recherche', 'icone' => 'fa-flask', 'couleur' => '#3498DB', 'desc' => 'Recherche et développement'],
                            'focus_installation_gmp' => ['label' => 'Installation GMP', 'icone' => 'fa-industry', 'couleur' => '#e74c3c', 'desc' => 'Production aux normes GMP'],
                            'focus_plante_medicinale' => ['label' => 'Plante Médicinale', 'icone' => 'fa-leaf', 'couleur' => '#27ae60', 'desc' => 'Culture et transformation'],
                            'focus_commercialisation' => ['label' => 'Commercialisation', 'icone' => 'fa-chart-line', 'couleur' => '#f39c12', 'desc' => 'Mise sur le marché'],
                            'focus_plateforme_complete' => ['label' => 'Plateforme Complète', 'icone' => 'fa-cubes', 'couleur' => '#9B59B6', 'desc' => 'Solution intégrée']
                        ];
                        foreach ($domaines as $cle => $domaine):
                        ?>
                        <div class="carte-coche" onclick="basculerCoche(this, 'focus')">
                            <input type="checkbox" name="<?= $cle ?>" value="1">
                            <div class="icone-coche" style="background: <?= $domaine['couleur'] ?>20; color: <?= $domaine['couleur'] ?>;">
                                <i class="fas <?= $domaine['icone'] ?>"></i>
                            </div>
                            <div class="fw-semibold"><?= htmlspecialchars($domaine['label']) ?></div>
                            <small class="text-muted"><?= htmlspecialchars($domaine['desc']) ?></small>
                        </div>
                        <?php endforeach; ?>
                    </div>
                </div>
            ...
            <div class="section-formulaire" id="etape-5">
                ...
                <div class="mb-4">
                    ...
                    <textarea class="controle-formulaire"
                              name="message_strategique"
                              id="message_strategique"
                              rows="4"
                              placeholder="Partagez toute information complémentaire sur votre intérêt pour ce partenariat..."
                              maxlength="65535"></textarea>
                    <div class="compteur-caracteres" id="message_strategique-compteur">0/65535</div>
                </div>
                ...
                <div class="mb-4 p-3 border rounded-3 bg-white">
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="checkbox" name="accepte_etre_contacte" id="accepte_etre_contacte" value="1" required>
                        <label class="form-check-label" for="accepte_etre_contacte">
                            <strong>J'accepte d'être contacté par l'équipe d'AGF Phytomed</strong>
                        </label>
                        <div class="retour-invalide" id="accepte_etre_contacte-erreur"></div>
                    </div>

                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="confirmation_non_contraignante" id="confirmation_non_contraignante" value="1" required>
                        <label class="form-check-label" for="confirmation_non_contraignante">
                            <strong>Je confirme que cette expression d'intérêt est non engageante</strong>
                        </label>
                        <div class="retour-invalide" id="confirmation_non_contraignante-erreur"></div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between mt-5">
                    ...
                    <button type="submit" class="btn btn-nav btn-soumettre" id="boutonSoumettre">
                        <span class="texte-bouton">
                            <i class="fas fa-paper-plane me-2"></i>Soumettre mon intérêt
                        </span>
                    </button>
                </div>
            </div>
    ...
    <div class="lien-statut">
        <p class="text-muted">
            Déjà enregistré ?
            <a href="<?= base_url('investisseurs/statut') ?>">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="fas fa-check-circle me-2"></i>Intérêt envoyé
                </h5>
            </div>
            <div class="modal-body">
                <div class="animation-succes">
                    <i class="fas fa-handshake"></i>
                </div>
                <h3>Merci <span id="prenomSucces">!</span></h3>
                <p class="text-muted">Nous avons bien reçu votre expression d'intérêt. Notre équipe vous contactera dans les plus brefs délais.</p>
...
<script>
    ...
    function initialiserCompteurs() {
        const champs = ['nom_complet', 'organisation', 'titre_poste', 'telephone', 'interet_autre', 'message_strategique'];
        champs.forEach(id => {
    ...
    window.basculerCoche = function(carte, groupe) {
        ...
        if (groupe === 'interet') verifierInteret();
    };

    function verifierInteret() {
        const champsInteret = ['interet_capitaux_propres', 'interet_dette', 'interet_financement_mixte', 'interet_subvention', 'interet_partenariat_strategique', 'interet_collaboration_technique', 'interet_achat_distribution'];
        let aInteret = false;
        for (let champ of champsInteret) {
            if (document.querySelector(`input[name="${champ}"]`)?.checked) {
                aInteret = true;
                break;
            }
        }
        const interetAutre = document.getElementById('interet_autre').value;
        if (aInteret || (interetAutre && interetAutre.trim().length > 0)) {
            document.querySelector('.erreur-interet').style.display = 'none';
        }
    }

    // ==================== VALIDATION ====================
    const reglesValidation = {
        nom_complet: { requis: true, min: 3, max: 150 },
        courriel: { requis: true, type: 'email', max: 150 },
        telephone: { pattern: /^[0-9+\-\s]+$/, max: 50 },
        organisation: { max: 150 },
        titre_poste: { max: 150 }
    };
    ...
    function validerEtape1() {
        ...
        if (!validerChamp('telephone')) estValide = false;
        return estValide;
    }
    ...
    function validerEtape3() {
        ...
        let aInteret = false;
        for (let champ of champsInteret) {
            if (document.querySelector(`input[name="${champ}"]`)?.checked) { aInteret = true; break; }
        }
        const interetAutre = document.getElementById('interet_autre').value;
        if (!aInteret && (!interetAutre || interetAutre.trim().length === 0)) {
            document.querySelector('.erreur-interet').style.display = 'block';
            estValide = false;
        } else {
            document.querySelector('.erreur-interet').style.display = 'none';
        }
    ...
    function validerEtape4() { return true; }

    function validerEtape5() {
        let estValide = true;
        const accepteContact = document.getElementById('accepte_etre_contacte');
        if (!accepteContact.checked) {
            accepteContact.classList.add('invalide');
            document.getElementById('accepte_etre_contacte-erreur').style.display = 'block';
            estValide = false;
        }
        const confirmationNonContraignante = document.getElementById('confirmation_non_contraignante');
        if (!confirmationNonContraignante.checked) {
            confirmationNonContraignante.classList.add('invalide');
            document.getElementById('confirmation_non_contraignante-erreur').style.display = 'block';
            estValide = false;
        }
        return estValide;
    }
    ...
    function genererResume() {
        ...
        const organisation = document.getElementById('organisation').value || 'Non fourni';
        const titrePoste = document.getElementById('titre_poste').value || 'Non fourni';
        const paysNom = document.getElementById('pays_nom').textContent || 'Non sélectionné';
        const interets = [];
        if (document.querySelector('input[name="interet_capitaux_propres"]')?.checked) interets.push('Capitaux Propres');
        if (document.querySelector('input[name="interet_dette"]')?.checked) interets.push('Dette');
        if (document.querySelector('input[name="interet_financement_mixte"]')?.checked) interets.push('Financement Mixte');
        if (document.querySelector('input[name="interet_subvention"]')?.checked) interets.push('Subvention');
        if (document.querySelector('input[name="interet_partenariat_strategique"]')?.checked) interets.push('Partenariat Stratégique');
        if (document.querySelector('input[name="interet_collaboration_technique"]')?.checked) interets.push('Collaboration Technique');
        if (document.querySelector('input[name="interet_achat_distribution"]')?.checked) interets.push('Achat/Distribution');
        const interetAutre = document.getElementById('interet_autre').value;
        if (interetAutre) interets.push('Autre : ' + interetAutre);
        const domainesFocus = [];
        if (document.querySelector('input[name="focus_laboratoire_recherche"]')?.checked) domainesFocus.push('Laboratoire de Recherche');
        if (document.querySelector('input[name="focus_installation_gmp"]')?.checked) domainesFocus.push('Installation GMP');
        if (document.querySelector('input[name="focus_plante_medicinale"]')?.checked) domainesFocus.push('Plante Médicinale');
        if (document.querySelector('input[name="focus_commercialisation"]')?.checked) domainesFocus.push('Commercialisation');
        if (document.querySelector('input[name="focus_plateforme_complete"]')?.checked) domainesFocus.push('Plateforme Complète');
        const fourchetteEngagement = document.getElementById('fourchette_engagement').value || 'Non spécifiée';
        const calendrier = document.getElementById('calendrier').value || 'Non spécifié';
        const messageStrategique = document.getElementById('message_strategique').value || 'Non fourni';
        let html = `
            ...
            <div class="element-resume"><span class="label-resume">Titre / Poste</span><span class="valeur-resume">${echapperHtml(titrePoste)}</span></div>
            <div class="element-resume"><span class="label-resume">Organisation</span><span class="valeur-resume">${echapperHtml(organisation)}</span></div>
        ...
        if (interets.length > 0) html += `<div class="section-resume"><h6><i class="fas fa-hand-holding-usd"></i> Types d'intérêt</h6><div>${interets.map(int => `<span class="badge-personnalise">${echapperHtml(int)}</span>`).join('')}</div></div>`;
        if (domainesFocus.length > 0) html += `<div class="section-resume"><h6><i class="fas fa-bullseye"></i> Domaines d'intérêt</h6><div>${domainesFocus.map(domaine => `<span class="badge-personnalise">${echapperHtml(domaine)}</span>`).join('')}</div></div>`;
        html += `<div class="section-resume"><h6><i class="fas fa-chart-bar"></i> Capacité d'engagement</h6>
            <div class="element-resume"><span class="label-resume">Fourchette d'engagement</span><span class="valeur-resume">${echapperHtml(fourchetteEngagement)}</span></div>
            <div class="element-resume"><span class="label-resume">Calendrier</span><span class="valeur-resume">${echapperHtml(calendrier)}</span></div></div>`;
        if (messageStrategique !== 'Non fourni') html += `<div class="section-resume"><h6><i class="fas fa-comment-dots"></i> Message stratégique</h6><p class="mb-0">${echapperHtml(messageStrategique)}</p></div>`;
    ...
    document.getElementById('formulaireInvestisseur').addEventListener('submit', async function(e) {
        ...
        try {
            const reponse = await fetch(urlSoumission, { method: 'POST', headers: { 'Content-Type': 'application/json', 'X-Requested-With': 'XMLHttpRequest' }, body: JSON.stringify(donnees) });
    ...
    function reinitialiserFormulaire() {
        ...
        effacerPays('pays');
        document.querySelectorAll('.compteur-caracteres').forEach(el => { const id = el.id.replace('-compteur', ''); const champ = document.getElementById(id); if (champ && champ.maxLength) el.textContent = `0/${champ.maxLength}`; });
        document.getElementById('fourchette_engagement').value = '';
        document.getElementById('calendrier').value = '';
        document.getElementById('interet_autre').value = '';
        document.getElementById('message_strategique').value = '';
    }

    function fermerModalSucces() { const modalEl = document.getElementById('modalSucces'); const modal = bootstrap.Modal.getInstance(modalEl); modal.hide(); }
</script>
