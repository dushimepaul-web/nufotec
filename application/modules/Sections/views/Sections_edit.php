    ...
    <div class="page-content">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white py-3">
                <h5 class="mb-0 text-warning"><i class="bx bx-edit me-2"></i>Modifier la section</h5>
            </div>
            <div class="card-body">
                <form id="sectionForm" action="<?= base_url('Sections/Update') ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="titre_section" value="<?= htmlspecialchars($detail['titre_section'] ?? '') ?>" placeholder="Titre principal">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label fw-bold">Sous-titre</label>
                            <input type="text" class="form-control" name="sous_titre" value="<?= htmlspecialchars($detail['sous_titre'] ?? '') ?>" placeholder="Sous-titre">
                        </div>

                        <div class="col-12">
                            <label class="form-label fw-bold">Contenu texte</label>
                            <textarea class="form-control" id="contenu_texte" name="contenu_texte" rows="15"><?= htmlspecialchars($detail['contenu_texte'] ?? '') ?></textarea>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="bouton_texte" value="<?= htmlspecialchars($detail['bouton_texte'] ?? '') ?>" placeholder="En savoir plus">
                        </div>
...
<!-- TinyMCE Self-Hosted (plus fiable) -->
...
tinymce.init({
    ...
    // TOOLBAR COMPLÈTE AVEC TABLEAU ET IMAGE BIEN VISIBLES
    toolbar: [
    ...
    setup: function(editor) {
        editor.on('init', function() {
            ...
            console.log('📊 Plugins tableaux: activés');
            console.log('🖼️ Upload images: configuré');
        });
