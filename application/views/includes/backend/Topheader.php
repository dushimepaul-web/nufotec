...
// Chemin de la photo
$photo_path = !empty($photo) ? 'attachments/users/' . $photo : 'assets/frontend/img/default-avatar.jpg';
...
<li class="nav-item">
        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item d-none d-sm-flex">
                <a class="nav-link" href="javascript:;" id="darkModeToggle" role="button">
                                ...
                                <a href="<?= base_url() ?>" target="_blank" class="text-decoration-none">
                                    <div class="app-box text-center p-3 rounded-3 hover-scale">
                                        <div class="app-icon mb-2">
                                            <img src="<?= base_url() ?>assets/backend/images/app/stack-overflow.png" width="36" height="36" alt="Home" class="rounded-circle" onerror="this.src='<?= base_url() ?>assets/backend/images/app/default-app.png'">
                                        </div>
                                        <div class="app-name">
                                            <p class="mb-0 text-body fw-medium small">Home</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col">
                                <a href="<?= base_url('Home/Actions') ?>" target="_blank" class="text-decoration-none">
                                    <div class="app-box text-center p-3 rounded-3 hover-scale">
                                        <div class="app-icon mb-2">
                                            <img src="<?= base_url() ?>assets/backend/images/app/stack-overflow.png" width="36" height="36" alt="Projects" class="rounded-circle" onerror="this.src='<?= base_url() ?>assets/backend/images/app/default-app.png'">
                                        </div>
                                        <div class="app-name">
                                            <p class="mb-0 text-body fw-medium small">Projects</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col">
                                <a href="<?= base_url('Home/Team') ?>" target="_blank" class="text-decoration-none">
                                    <div class="app-box text-center p-3 rounded-3 hover-scale">
                                        <div class="app-icon mb-2">
                                            <img src="<?= base_url() ?>assets/backend/images/app/stack-overflow.png" width="36" height="36" alt="Team" class="rounded-circle" onerror="this.src='<?= base_url() ?>assets/backend/images/app/default-app.png'">
                                        </div>
                                        <div class="app-name">
                                            <p class="mb-0 text-body fw-medium small">Team</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col">
                                <a href="<?= base_url('Home/Galleries') ?>" target="_blank" class="text-decoration-none">
                                    <div class="app-box text-center p-3 rounded-3 hover-scale">
                                        <div class="app-icon mb-2">
                                            <img src="<?= base_url() ?>assets/backend/images/app/stack-overflow.png" width="36" height="36" alt="Galleries" class="rounded-circle" onerror="this.src='<?= base_url() ?>assets/backend/images/app/default-app.png'">
                                        </div>
                                        <div class="app-name">
                                            <p class="mb-0 text-body fw-medium small">Galleries</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" data-bs-toggle="dropdown" href="#" role="button">
                    ...
                    <span class="navbar-badge badge text-bg-danger"><?= $notif_count > 9 ? '9+' : $notif_count ?></span>
                    <?php endif; ?>
                </a>
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    <span class="dropdown-item dropdown-header"><?= $notif_count ?> Notification<?= $notif_count > 1 ? 's' : '' ?></span>
                    ...
                    <a href="#" class="dropdown-item">
                        ...
                        <?= htmlspecialchars($n['message'] ?? $n['titre'] ?? 'Notification') ?>
                        <span class="float-end fs-7 text-secondary"><?= time_ago($n['created_at']) ?></span>
                    </a>
                    <div class="dropdown-divider"></div>
                    <?php endforeach; ?>
                    <?php endif; ?>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" data-bs-toggle="dropdown" href="#" role="button">
                    ...
                    <?php if ($msg_count > 0): ?>
                    <span class="navbar-badge badge text-bg-success"><?= $msg_count > 9 ? '9+' : $msg_count ?></span>
                    <?php endif; ?>
                </a>
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    <span class="dropdown-item dropdown-header"><?= $msg_count ?> Message<?= $msg_count > 1 ? 's' : '' ?></span>
                    <div class="dropdown-divider"></div>
                    <?php if (empty($recent_messages)): ?>
                    <span class="dropdown-item">Aucun message</span>
                    <?php else: ?>
                    <?php foreach ($recent_messages as $m): ?>
                    <a href="<?= base_url('contact_us/Contact_Us') ?>" class="dropdown-item">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="dropdown-item-title"><?= htmlspecialchars($m['nom'] ?? $m['name'] ?? 'Contact') ?></p>
                                <p class="fs-7 text-secondary text-truncate" style="max-width: 240px;"><?= htmlspecialchars(strip_tags($m['message'] ?? '')) ?></p>
                            </div>
                        </div>
                    </a>
                    <div class="dropdown-divider"></div>
                    <?php endforeach; ?>
                    <?php endif; ?>
                    <a href="<?= base_url('contact_us/Contact_Us') ?>" class="dropdown-item dropdown-footer">Voir tous les messages</a>
                </div>
            </li>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link d-flex align-items-center gap-2" data-bs-toggle="dropdown" href="#" role="button">
                    ...
                    <img src="<?= base_url($photo_path) ?>" class="user-img rounded-circle border border-2 border-primary" width="36" height="36" alt="Avatar" onerror="this.src='<?= base_url('assets/frontend/img/default-avatar.jpg') ?>'">
                    <?php else: ?>
                    <div class="avatar-placeholder rounded-circle d-flex align-items-center justify-content-center bg-primary text-white" style="width: 36px; height: 36px; font-weight: bold; font-size: 13px;"><?= $initials ?></div>
                    <?php endif; ?>
                    <div class="user-info d-none d-md-block lh-1">
                        <p class="mb-0 fw-semibold" style="font-size: 14px;"><?= htmlspecialchars($nom_complet) ?></p>
                        <p class="mb-0 text-secondary" style="font-size: 12px;"><?= !empty($user_role) ? htmlspecialchars($user_role) : 'Utilisateur' ?></p>
                    </div>
                </a>
                <div class="dropdown-menu dropdown-menu-end shadow" style="min-width: 250px;">
                    <div class="dropdown-header bg-body">
                        <div class="d-flex align-items-center">
                            <div class="me-3">
                                <?php if (!empty($photo) && file_exists(FCPATH . $photo_path)): ?>
                                <img src="<?= base_url($photo_path) ?>" class="rounded-circle" width="45" height="45" alt="Avatar" onerror="this.src='<?= base_url('assets/frontend/img/default-avatar.jpg') ?>'">
                                <?php else: ?>
                                <div class="rounded-circle bg-primary text-white d-flex align-items-center justify-content-center" style="width: 45px; height: 45px;"><?= $initials ?></div>
                                <?php endif; ?>
                            </div>
                            <div>
                                <h6 class="mb-0"><?= htmlspecialchars($nom_complet) ?></h6>
                                <small class="text-secondary"><?= !empty($email) ? htmlspecialchars($email) : 'Non défini' ?></small>
                            </div>
                        </div>
                    </div>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="javascript:;" data-bs-toggle="modal" data-bs-target="#profileViewModal">
                        <i class="bi bi-person me-2"></i>Mon Profil (Détails)
                    </a>
                    <a class="dropdown-item" href="javascript:;" data-bs-toggle="modal" data-bs-target="#profileEditModal">
                        <i class="bi bi-pencil me-2"></i>Modifier mon profil
                    </a>
                    <a class="dropdown-item" href="<?= base_url('Configurations') ?>">
                        <i class="bi bi-gear me-2"></i>Paramètres
                    </a>
                    <a class="dropdown-item" href="<?= base_url('Contact_Us') ?>">
                        <i class="bi bi-bell me-2"></i>Notifications
                        <?php if (!empty($message_non_lus) && $message_non_lus > 0): ?>
                        <span class="badge text-bg-primary float-end"><?= (int) $message_non_lus ?></span>
                        <?php endif; ?>
                    </a>
                    <div class="dropdown-divider"></div>
                            ...
                            <div class="p-4 text-center border-bottom">
                                <div class="position-relative d-inline-block mb-3">
                                    <div class="profile-photo-container" style="width: 120px; height: 120px; margin: 0 auto;">
                                        <img src="<?= $photo_exists ? base_url($photo_path) : base_url('assets/frontend/img/default-avatar.jpg') ?>" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    images.forEach(img => {
        img.onerror = function() {
            this.src = '<?= base_url("assets/frontend/img/default-avatar.jpg") ?>';
        };
    });
