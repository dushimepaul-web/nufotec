...
<div class="mobile-sticky-footer d-lg-none">
    ...
    <a href="<?= base_url('onsultations/PatientForm/Medicin') ?>" class="sticky-nav-item">
    ...
    <a href="#" class="sticky-nav-item cart-item" onclick="openCart()">
        <i class="bi bi-cart3"></i>
        <span>Cart</span>
        <span class="sticky-badge cart-count" id="cartFloatBadge">0</span>
    </a>
...
// Update Cart Badge
function updateFooterCartBadge(count) {
